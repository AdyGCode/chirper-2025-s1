<x-guest-layout>
    ...
    <div class="py-12 space-y-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 gap-6 flex flex-col">
                    <h2 class="text-2xl font-semibold text-zinc-50 bg-zinc-600 p-4 pb-6 -mx-4 -mt-4 rounded-t">
                        Privacy Policy
                    </h2>
                    ...
                    <section class=" -mx-4 bg-red-500 text-white p-4 text-xl space-y-4 rounded-b">
                        <p>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <article class="bg-white container mx-auto border grow h-full shadow-md p-4 pb-8 rounded flex flex-col gap-6">
                    <h2 class="text-2xl text-zinc-50 bg-zinc-600 p-3 px-6 -mx-4 -mt-4 rounded-t">
